...
{
    private static readonly Expression<Func<Person, int>> _incrementalComputed =
    ...
    public async void TestCollectionElementAdded()
    {
        ...
        var changes = await context.GetChangesAsync(_incrementalComputed, static c => c.NumberIncremental());
